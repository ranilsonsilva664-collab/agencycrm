    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <select value={categoryFilter} onChange={(e) => setCategoryFilter(e.target.value)}
          className="px-4 py-3 bg-gray-900/50 border border-gray-800 rounded-xl text-white focus:outline-none focus:border-blue-500/50 transition-all">
                ...
                <tr key={project.id} className="hover:bg-gray-800/30 transition-colors group">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center justify-end gap-1">
                      ...
                      <button onClick={() => openEdit(project)} className="p-2 text-gray-400 hover:text-blue-400 hover:bg-blue-500/10 rounded-lg transition-colors" title="Editar">
      ...
      <Modal open={modalOpen} onClose={closeModal} title={editingProject ? 'Editar Projeto' : 'Novo Projeto'} size="xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="md:col-span-2">
            ...
            <label className="flex items-center gap-3 px-4 py-3 border-2 border-dashed border-gray-700 rounded-xl cursor-pointer hover:border-blue-500/50 hover:bg-blue-500/5 transition-all group">
              <Upload className="h-5 w-5 text-gray-500 group-hover:text-blue-400" />
          ...
          <div className="space-y-5">
                ...
                <div className="space-y-2">
                  {viewingProject.files.map((f) => (
                    <a key={f.id} href={f.url} target="_blank" rel="noreferrer"
                      className="flex items-center gap-2 px-3 py-2 bg-gray-800/50 rounded-lg border border-gray-700/50 hover:border-blue-500/40 transition-colors">
                      <Link2 className="h-4 w-4 text-blue-400" />
            ...
            <div className="flex gap-3 pt-4 border-t border-gray-800">
              <button onClick={() => { setDetailOpen(false); openEdit(viewingProject); }}
                className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-blue-500/20 text-blue-400 hover:bg-blue-500/30 transition-colors font-medium">
